...
void main() {
  group("Mock Authentication", () {
    ...
    test("Should be able to initialize in less than 2 seconds", () async {
      ...
      expect(provider.isInitialized, true);
        ...
        timeout: const Timeout(Duration(
            seconds:
                2))); // if it cant initialize within 2 seconds it will fail!
    ...
    test("Logged in user should be to get verified", () {
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({required String email, required String password}) {
    ...
    _user = const AuthUser(
        id: "my_id", isEmailVerified: false, email: "foo@barcom");
  ...
  Future<void> sendEmailVerification() async {
    ...
    if (_user == null) throw UserNotFoundAuthException();
    _user = const AuthUser(
        id: "my_id", isEmailVerified: true, email: 'foo@bar.com');
  }
}
